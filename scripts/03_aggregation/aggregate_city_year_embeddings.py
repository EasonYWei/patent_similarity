"""Aggregate patent-level embeddings into city-year embeddings."""

from __future__ import annotations

from tools.cli import parse_aggregation_cli, setup_logging
from tools.config import DEFAULT_CITY_YEAR_OUTPUT_DIR
...
def main(argv: list[str] | None = None) -> int:
    args = parse_aggregation_cli(
        "Aggregate city-year patent embeddings",
        argv,
        default_output_dir=DEFAULT_CITY_YEAR_OUTPUT_DIR,
    )
