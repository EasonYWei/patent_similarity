#!/usr/bin/env python3
"""Compute city-year lagged similarity metrics from embedding CSVs."""
...
def parse_args(argv: list[str] | None = None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Compute city-year patent similarity")
...
def main(argv: list[str] | None = None) -> int:
    ...
    run_similarity_for_model(CITY_SPEC, model_short_name(args.model), args.output_dir)
    return 0
